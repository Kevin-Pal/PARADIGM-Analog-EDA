...
> Intelligent Database-Guided Methodology,"* ISEDA 2026, pp. 229–235.
...
| CART decision-tree visualisation (first three levels) | `notebooks/05_topology_prediction.ipynb` (`plot_tree`) |
...
| **Table I**: six classifiers, Acc / Acc Std / F1-macro / fit & score time | `notebooks/05_topology_prediction.ipynb` | ✅ re-run 2026-08 — see [`reproduce.md`](reproduce.md) |
...
> label was left untouched so that the stored notebook outputs remain the original run's evidence.
